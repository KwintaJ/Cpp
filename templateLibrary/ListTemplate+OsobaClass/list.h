...
public:
    ...
    void sort()
    {
        ...
        for(iterator it0 = begin(); it0 != iterator{tail}; ++it0)
        {
    ...
    {
        iterator helpItr1 = begin();
        for(helpItr1; helpItr1 != iterator{tail}; ++helpItr1)
        {
            if(!(helpItr1 != e))
                break;
        }
        for(iterator it0 = b; it0 != helpItr1; ++it0)
        {
            for(iterator it1 = b; it1 != helpItr1; ++it1)
            {
                iterator it2 = it1;
                ++it2;
                if((*it2) < (*it1))
